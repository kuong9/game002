...
const STAGE_IMAGES = [
  "assets/background_stage1.webp",
  "assets/background_stage2.webp",
  "assets/background_stage3.webp",
  "assets/background_stage4.webp",
  "assets/background_stage5.webp",
];
const FAIL_IMAGE = "assets/background2.webp";
const ENEMY_IMAGE_SRC = "assets/enemy.png";
...
function update() {
  ...
  if (!player.inSafeZone && particles.length < 50) {
